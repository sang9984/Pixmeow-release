...
- Crash reports (beyond the optional macOS system reports you can opt into)
- Cookies, tracking identifiers, or advertising IDs
...
This data never leaves your Mac. There is no cloud sync, no backend server, no third-party service.
...
- **Notifications** (optional): Used to deliver memo reminders at user-scheduled times. Notification content is generated locally from memos you wrote.
...
If this policy changes, the updated version will be posted at the same URL with the new "Last updated" date. Material changes will be noted in the app's release notes.
